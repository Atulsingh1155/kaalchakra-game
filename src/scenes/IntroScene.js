export class IntroScene extends Phaser.Scene {
  ...
  //   this.fullscreenButton = this.add.text(20, 20, 'Press F for Fullscreen', {
  //     font: '16px Arial',
  //     fill: '#FFFFFF',
  //     backgroundColor: '#000000AA',
  //     padding: { x: 8, y: 4 }
  ...
  //     this.fullscreenButton.setText('Press F for Fullscreen');
  //   } else {
  //     this.scale.startFullscreen();
  //     this.fullscreenButton.setText('Press F to Exit Fullscreen');
  //   }
  // }
}