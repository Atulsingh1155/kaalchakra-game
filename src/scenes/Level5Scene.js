...
export class Level5Scene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(50, 50, [
      ...
      "Dadi: This is it beta! Save your father!",
      "Collect 10 coins and run 100 meters! (Ultimate challenge!)"
    ], { font: "18px serif", fill: "#fff", wordWrap: { width: 860 } });
    
    this.player = new Aarav(this, 100, 400);
    this.cursors = this.input.keyboard.createCursorKeys();
    
    // Boss-level enemies for level 5
    this.enemies = this.physics.add.group();
    for (let i = 0; i < 5; i++) {
      this.enemies.add(new Enemy(this, 50 + (i * 15), 400, GameData.levelConfigs[5].enemySpeed - (i * 5)));
    }
  ...
  completeLevel() {
    ...
    this.add.text(300, 200, [
      "Dadi: You did it beta! Your father is saved!",
      "Victory is yours!",
      "Click to celebrate..."
    ], { 
      font: "20px serif", 
